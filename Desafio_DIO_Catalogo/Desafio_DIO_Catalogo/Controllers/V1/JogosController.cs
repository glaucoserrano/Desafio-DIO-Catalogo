using Desafio_DIO_Catalogo.Exceptions;
using Desafio_DIO_Catalogo.InputModel;
using Desafio_DIO_Catalogo.Services;
...
namespace Desafio_DIO_Catalogo.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        /// <summary>
        /// Busca todos jogos de forma paginada
        /// </summary>
        ...
        /// <summary>
        /// Altera os dados do jogo, que foi passado o ID
        /// </summary>
        /// <param name="idJogo"></param>
        /// <param name="jogoInputModel"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Altera o preço do jogo, que foi passado pelo ID
        /// </summary>
        /// <param name="idJogo"></param>
        ...
        /// <summary>
        /// Apaga os jogos com o ID passado
        /// </summary>
        /// <param name="idJogo"></param>
        /// <returns></returns>
